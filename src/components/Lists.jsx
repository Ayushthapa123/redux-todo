...
import { deleteTodo,DeleteAllTodo, } from '../actions/todocurd';
...
const {setTodolists,setShowupdatebutton,setUpdateindex,setTask,
 ...
 const todolists=useSelector((store)=> store.todoReducer.list)
    ...
    <div className='todolistscontainer'>
        ...
        {filter=="all" &&<div>
            {todolists.map((list,index)=> (
                <div key={list.id} id={list.id}>
                    <p>{!todolists[index].completed &&<i onClick={(e)=>MarkComplete(e)}><ImCheckboxUnchecked/></i>}{todolists[index].completed &&<i onClick={(e)=>MarkComplete(e)}><ImCheckboxChecked/></i>}<b>{list.task}</b> <span><i onClick={(e)=>MarkUpdate(list.id)}><FaPenSquare/></i> | <i onClick={(e)=>dispatch(deleteTodo(list.id))}><AiTwotoneDelete/></i></span></p>
        ...
        {filter=="completed" &&<div>
            ...
            return list
                ...
                <div key={list.id} id={list.id}>
                    <p><i onClick={(e)=>MarkComplete(e)}><ImCheckboxChecked/></i><b>{list.task}</b> <span><i onClick={(e)=>MarkUpdate(e)}><FaPenSquare/></i> | <i onClick={(e)=>dispatch(deleteTodo(list.id))}><AiTwotoneDelete/></i></span></p>
                    <i>{list.description}</i>
        ...
        {filter=="notcompleted" &&<div>
            ...
            return list
                ...
                <div key={list.id} id={list.id}>
                    <p><i onClick={(e)=>MarkComplete(e)}><ImCheckboxUnchecked/></i><b>{list.task}</b> <span><i onClick={(e)=>MarkUpdate(e)}><FaPenSquare/></i> | <i onClick={(e)=>dispatch(deleteTodo(list.id))}><AiTwotoneDelete/></i></span></p>
                    <i>{list.description}</i>
        ...
        {filter=="categories" &&<div>
            ...
            return list
                ...
                <div key={list.id} id={list.id}>
                    <p>{!list.completed &&<i onClick={(e)=>MarkComplete(e)}><ImCheckboxUnchecked/></i>}{list.completed &&<i onClick={(e)=>MarkComplete(e)}><ImCheckboxChecked/></i>}<b>{list.task}</b> <span><i onClick={(e)=>MarkUpdate(e)}><FaPenSquare/></i> | <i onClick={(e)=>dispatch(deleteTodo(list.id))}><AiTwotoneDelete/></i></span></p>
                    <i>{list.description}</i>
...
<div className='clearall'>
    <button onClick={(e)=>dispatch(DeleteAllTodo())}>Clear All</button>
</div>
